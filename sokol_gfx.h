...
_SOKOL_PRIVATE GLenum _sg_gl_teximage_internal_format(sg_pixel_format fmt) {
    ...
    if (_sg.gl.gles2) {
        ...
        switch (fmt) {
            ...
            case SG_PIXELFORMAT_SRGBA8:     return GL_SRGB8_ALPHA8;
...
_SOKOL_PRIVATE void _sg_gl_init_pixelformats(bool has_bgra) {
    ...
    #if !defined(SOKOL_GLES2)
    if (!_sg.gl.gles2) {
        _sg_pixelformat_all(&_sg.formats[SG_PIXELFORMAT_SRGBA8]);
...
_SOKOL_PRIVATE DXGI_FORMAT _sg_d3d11_pixel_format(sg_pixel_format fmt) {
    switch (fmt) {
        ...
        case SG_PIXELFORMAT_SRGBA8:         return DXGI_FORMAT_R8G8B8A8_UNORM_SRGB;
...
_SOKOL_PRIVATE MTLPixelFormat _sg_mtl_pixel_format(sg_pixel_format fmt) {
    switch (fmt) {
        ...
        case SG_PIXELFORMAT_SRGBA8:                 return MTLPixelFormatRGBA8Unorm_sRGB;
...
_SOKOL_PRIVATE WGPUTextureFormat _sg_wgpu_textureformat(sg_pixel_format p) {
    switch (p) {
        ...
        case SG_PIXELFORMAT_SRGBA8:         return WGPUTextureFormat_RGBA8UnormSrgb;
